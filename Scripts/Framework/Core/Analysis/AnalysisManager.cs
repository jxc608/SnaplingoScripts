...
public class AnalysisManager : Manager
{
	...
	protected override void Init()
	{
		...
		{
			AppKey_Android = ConfigurationController.Instance.UmengAppKey_AndroidFormal;
			AppKey_ios = ConfigurationController.Instance.UmengAppKey_iosFormal;
		}
		else
		{
			AppKey_Android = ConfigurationController.Instance.UmengAppKey_AndroidTest;
			AppKey_ios = ConfigurationController.Instance.UmengAppKey_iosTest;
		}

		// Umeng
#if UNITY_ANDROID
		GA.StartWithAppKeyAndChannelId (AppKey_Android, MiscUtils.GetChannel ());
#elif UNITY_IPHONE
		GA.StartWithAppKeyAndChannelId(AppKey_ios, MiscUtils.GetChannel());
#endif

...
namespace Snaplingo.UI
{
	public static class UIUtils
	{
        ...
        public static Vector2 GetCanvasPosFromTouchPosition(Vector2 touchPosition)
        {
            return new Vector2((touchPosition.x - Screen.width * 0.5f) / Screen.width * PageManager.Instance.GetComponent<RectTransform>().sizeDelta.x, 
                               (touchPosition.y - Screen.height * 0.5f) / Screen.height * PageManager.Instance.GetComponent<RectTransform>().sizeDelta.y);
        }
        ...
        public static void SetSize(this Transform trans, Vector2 size)
        {
        ...
        public static void SetRectHeight(this Transform trans, float height)
        {
            RectTransform rt = trans.GetComponent<RectTransform>();
            if (rt)

...
public class ConfigurationController : ScriptableObject
{
	...
	[Space(10)]
	[Header("OSS配置")]
	public string[] OSSListBucketNames;
	public string[] OSSListEndPoints;
	public string[] OSSListGamePaths;
	...
	[Space(10)]
	[Header("友盟AppKey配置")]
	public string UmengAppKey_iosTest;
	public string UmengAppKey_iosFormal;
	public string UmengAppKey_AndroidTest;
	public string UmengAppKey_AndroidFormal;

	[Space(10)]
	[Header("Bugly AppID配置")]
	public string BuglyAppKey_iosTest;
	public string BuglyAppKey_iosFormal;
	public string BuglyAppKey_AndroidTest;
	public string BuglyAppKey_AndroidFormal;
	...
	[Space(10)]
	[Header("科大讯飞ID")]
	public string _XunfeiSRID = "59f9b055";
